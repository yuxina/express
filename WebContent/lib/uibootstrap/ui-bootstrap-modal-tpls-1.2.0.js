    ...
    .factory('$uibModalStack', ['$animate', '$animateCss', '$document',
        ...
        function ($animate, $animateCss, $document, $compile, $rootScope, $q, $$multiMap, $$stackedMap) {
            ...
            $modalStack.open = function (modalInstance, modal) {
                ...
                var angularDomEl = angular.element('<div uib-modal-window="modal-window"></div>');//uib-modal-window="modal-window"
                ...
                $(window).resize(function(){
                    var modalContent = angularDomEl.children().children();
                    var _domW = modalContent.width()/2;
                    var _domH = modalContent.height()/2;
                    modalContent.css({'margin-left':-_domW,'margin-top':-_domH}).fadeIn();
                });
