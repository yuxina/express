			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<span class="select-box"> <s:select cssClass="select"
							list="proTypeList" listValue="proTypeName" listKey="proTypeId"
							name="proType.proTypeId" id="proType.proTypeId">
						</s:select>
					</span>
				</div>
			</div>
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" name="proAmount" id="proAmount" placeholder=""
						value="" class="input-text" style="width: 50%">
				</div>
			</div>
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<textarea name="proDesc" cols="" rows="" class="textarea"
						placeholder="说点什么..." onKeyUp="textarealength(this,200)"></textarea>
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<div class="uploader-thum-container">
						<img id="ImgPr" style="width: 100px; height: 100px;" src="" alt="" />
...
$(function(){
	...
	$("#form-product-add").validate({
		...
		submitHandler:function(form){
			...
			$.ajax({
				type : "post",
				url : "${pageContext.request.contextPath }/pages/product_add.action",
				data : formData,
				cache: false,
				contentType: false,
				processData: false,
